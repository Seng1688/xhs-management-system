...
- Generated context root hint: `/Users/sam/Desktop/project/xhs-management-system/xhs-management-system`. If this path exists, run workspace commands from there.
...
extend last time cpm code based to create ui to create a claims workflow.
now gathering requirenment and 